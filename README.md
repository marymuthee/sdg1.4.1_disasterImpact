...
The work was developed as part of my master's studies under the  **Advanced Cartography Course** and demonstrates the integration of geospatial data processing, thematic cartography, and interactive web mapping using R and Leaflet.
